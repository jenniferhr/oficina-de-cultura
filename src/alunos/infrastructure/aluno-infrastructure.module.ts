...
import { InMemoryAlunosPersistenceModule } from './persistence/in-memory/in-memory-persistence.module';
import { InFileAlunosPersistenceModule } from './persistence/in-file/in-file-persistence.module';
...
export class AlunoInfrastructureModule {
  static use(driver: 'in-file' | 'in-memory') {
    const persistenceModule =
      driver === 'in-file'
        ? InFileAlunosPersistenceModule
        : InMemoryAlunosPersistenceModule;
